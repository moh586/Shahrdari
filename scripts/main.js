(function($, doc) {
	...
	_app = {
		...
		singleProjectShow: function (args) {
		    var title = args.view.params.title,
    			description = args.view.params.description,
    			url = args.view.params.url;

		    singleProjectViewModel.setValues(cardNumber, bonusPoints, cardAmount);
		},

		singleProjectInit: function (e) {
		    var container = e.view.content,
    			$cardFront = container.find("#cardFront"),
    			$cardBack = container.find("#cardBack");

		    singleProjectViewModel.appendProjectFadeEffect($cardFront, $cardBack);
		},
