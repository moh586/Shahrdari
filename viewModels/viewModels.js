(function($, console, doc) {
	...
	ProjectsViewModelBase = kendo.data.ObservableObject.extend({
	    init: function () {
	        var that = this;
	    ...
	    _generateImageUrl: function (projectId) {
	        var size = "130",
	    ...
	    appendProjectFadeEffect: function ($cardFront, $cardBack) {
